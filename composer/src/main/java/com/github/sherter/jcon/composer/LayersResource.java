  ...
  public Response post(@Context UriInfo info, LayerConfig config) throws IOException {
    ...
    switch (config.getType()) {
      ...
      case "pbce":
        ...
        break;
      case "throttle":
        id = layerService.createThrottleLayer();
        break;
      case "pbce2":
        try {
      ...
      case "tablevisor":
        ...
        break;
      case "shortest_path_calculator":
        id = layerService.createShortestPathCalculaterLayer(config.getConfig());
        break;
      case "forward":
        id = layerService.createForwardLayer();
        break;
      case "port_changer":
        id = layerService.createPortChanger();
        break;
      default:
