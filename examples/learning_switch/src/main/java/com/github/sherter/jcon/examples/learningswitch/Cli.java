...
class Cli {
  ...
  public static void main(String[] args) throws IOException {
    ...
    SdnAppFramework LearningSwitch =
        new SdnAppFramework(parsedArgs.upstreamAddress, reactor, new SimpleSwitch());
    ...
    reactor.listen(
        parsedArgs.listenAddress,
        LearningSwitch.callbackFactoryForNewSwitchConnections(),
        LearningSwitch::acceptConnectionFromSwitch);
    reactor.loop();
  }
