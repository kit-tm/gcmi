...
This file contains a re-implementation of PBCE (see https://ieeexplore.ieee.org/document/7809656).

The relevant code is structured as follows:

METHODS_REWRITE: Methods which rewrite messages (e.g. for installation on the delegation switch)
METHODS_MSG: Methods which implement OF message handling
...
public class Pbce2Layer implements Layer {
    ...
    // Handle incoming packets and forward to upper layer
    // Rewrites packets coming from an evicted port
    ...
    // Handle FlowMod messages
    // Rewrites Flows for evicted port for installation on extension switch
    ...
    // Collect Port and Table stats
    // TableStatsReply triggers decision algorithm
