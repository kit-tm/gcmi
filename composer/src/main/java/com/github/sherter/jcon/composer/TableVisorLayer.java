...
This file contains a partial re-implementation of TableVisor (see https://ieeexplore.ieee.org/document/7313631, https://ieeexplore.ieee.org/document/8004108).

The relevant code is structured as follows:

METHODS_SWITCH_MSG: Switch OF message handling
METHODS_CONTROLLER_MSG: Controller OF message handling

You can use your editors search functionality to search these keys.
...
public class TableVisorLayer implements Layer {
    ...
    // BackFlow rule to feed back from last switch to outgoing switch
    ...
    // Use refcounting to wait until all switches have responded
    ...
    // Rewrites Flows for installation on the correct switch
    ...
    // trivially send to first switch
    ...
    // broadcast barrier request among all participating switches
